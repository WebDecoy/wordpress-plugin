                ...
                <table class="form-table">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <p class="description">
                                <?php esc_html_e('This is the secret path behind the hidden link. Open it yourself in a new tab and the detection appears on the Detections page. Tripping your own canary is the fastest proof the whole pipeline works. (If your IP is on the allowlist, the trip is ignored.)', 'webdecoy'); ?>
